...
import { useRouter } from "next/navigation";
  ...
  <div className="space-y-10 p-2">
    ...
    <div className="space-y-10 p-2">
      ...
      <div className="flex flex-row h-[20%] mt-2-corners justify-between items-center">
   ...
   <div className="grid md:grid-cols-4 gap-8 mt-10">
      <div className="text-center">
          <img
            ...
            alt="Burger 1"
            className="rounded-[20px] w-[300px] h-[300px] object-coverr"
          />
      ...
      </div> <div className="text-center"><div className="bg-[#1a1a1a] rounded-3xl p-6 border-1/2 border-white hover:border-yellow-400 transition duration-300 w-[300px] h-[460px] flex flex-col items-center"><div className="text-center">
          <img 
      ...
      <div className="text-center">
          <img
            ...
            alt="Burger 1"
            className="rounded-[20px] w-[350px] h-[300px] object-coverr"
          />
  ...
  <div className="flex flex-row h-[5%] mt-30 w-full justify-between items-center">
     <section className="bg-black text-white py-10 w-full flex flex-col items-center justify-center">
    <div className="flex items-center">
      <div className="border-t border-red-600 w-16"></div>
      <h2 className="text-red-600 text-lg font-bold mx-4 tracking-widest">
    ...
    <div className="flex flex-row h-[30%] mt-30 w-full justify-between items-center">
  ...
  <div className="flex overflow-x-auto gap-25 px-25 scrollbar-hide ">
    ...
    <div className="min-w-[250px] bg-[#111] rounded-2xl p-2 text-center hover:scale-105 transition">
      <img
        ...
        className="w-52 h-42 mx-auto mb-4"
      />
      <h3 className="text-xl font-semibold">Classic Chicken burger</h3> 
      <p className="text-gray-400 text-sm mt-2">
        Ricotta/goat cheese/beetroot<br /> Ricotta/goat cheese/beetroot
      </p>
      <span className="inline-block mt-3 text-xs bold bg-red-500 px-3 py-1 rounded-half">
